      ...
      <div className="tab-body">
        {activeTab === 'overview' && (
          <div className="two-col">
            <div>
              ...
              <div className="body-text body-text-emphasis">{brand.keyMessage}</div>
        ...
        {activeTab === 'content' && (
          <div className="two-col">
            <div>
              ...
              {(brand.formats || []).map((f, i) => (
                <div key={i} className="format-row">
                  <i className="ti ti-file-text format-icon" aria-hidden="true" />
                  <span>{f}</span>
                </div>
              ))}
            </div>
            <div>
              ...
              <div className="tone-chip">
                ...
                />
                <span style={{ fontWeight: 600, color: toneColor }}>{brand.tone}</span>
              </div>
        ...
        {activeTab === 'differentiation' && (
          <div>
            ...
            <div className={`diff-block ${!brand.differentiator ? 'empty' : ''}`}>
